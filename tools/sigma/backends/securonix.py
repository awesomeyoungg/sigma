# Securonix backend for sigmac created by SOC Prime
...
class SecuronixBackend(SingleTextQueryBackend):
    """Converts Sigma rule into Securonix saved search. Contributed by SOC Prime. https://socprime.com"""
    ...
    def __init__(self, *args, **kwargs):
        ...
        aFL = ["rg_vendor", "rg_functionality", "resourcetype"]
    ...
    def generateCleanValueNodeLogsource(self, value):
        #print(self.cleanValue(str(value)))
    ...
    # generateORNode algorithm for SecuronixBackend class.
...
class SecuronixESMBackend(SingleTextQueryBackend):
    """Converts Sigma rule into Securonix ESM saved search. Contributed by SOC Prime. https://socprime.com"""
    reEscape = re.compile('(["\\\()])')
    identifier = "securonix-esm"
    active = True
    andToken = " AND "
    orToken = " OR "
    notToken = " NOT "
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        aFL = ["Vendor", "Functionality", "ResourceType"]
